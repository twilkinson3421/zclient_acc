...
pub fn parseRegistrationResult(reader: *binutils.Reader) !msg.RegistrationResult {
...
pub fn parseRealtimeUpdate(reader: *binutils.Reader) !msg.RealtimeUpdate {
...
pub fn parseRealTimeCarUpdate(reader: *binutils.Reader) !msg.RealtimeCarUpdate {
...
pub fn parseEntryList(allocator: std.mem.Allocator, reader: *binutils.Reader) ![]u16 {
...
pub fn parseTrackData(allocator: std.mem.Allocator, reader: *binutils.Reader) !msg.TrackData {
    ...
    while (camera_set_count > 0) : (camera_set_count -= 1) {
        ...
        const camera_set_case =
            std.meta.stringToEnum(enums.CameraSetName, camera_set_name) orelse continue;
